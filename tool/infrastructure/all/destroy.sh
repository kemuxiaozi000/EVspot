...
aws elasticbeanstalk delete-application --application-name ${APPLICATION_NAME}-review --terminate-env-by-force
aws elasticbeanstalk delete-application --application-name ${APPLICATION_NAME}-staging --terminate-env-by-force
