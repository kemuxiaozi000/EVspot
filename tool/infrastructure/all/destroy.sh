...
echo Destroy ${APPLICATION_NAME}, region: ${REGION}, bucket: ${EB_BUCKET}
...
aws elasticbeanstalk delete-application --application-name ${APPLICATION_NAME}-worker --terminate-env-by-force
